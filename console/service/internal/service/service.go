...
func NewService(
	...
	guardedOperations := cluster.NewGuardedOperationsHandler(db, dockerManager, logCollector, clusterWatcher, cfg, log.Logger)
	api.ClusterPostClustersIDPreflightsHandler = clusterapi.PostClustersIDPreflightsHandlerFunc(guardedOperations.HandlePreflight)
	api.ClusterPostClustersIDOperationsHandler = clusterapi.PostClustersIDOperationsHandlerFunc(guardedOperations.HandleOperation)
