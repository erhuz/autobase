...
func TestManagementVersionSet(t *testing.T) {
	...
	if set.Schema != 1 || set.Name != "management-v1" || set.SourceBaseline != "2.9.0" ||
		set.ReleaseVersion != "2.9.0-management.7" || set.Platform != "linux/amd64" ||
...
func TestImageRegistryContract(t *testing.T) {
	...
	contracts := []struct {
		...
		{"console/docker-compose.yml", []string{"ghcr.io/erhuz/console_api:2.9.0-management.7", "ghcr.io/erhuz/console_ui:2.9.0-management.7", "autobase/console_db:2.9.0"}, []string{"ghcr.io/erhuz/console_db:"}},
		{"console/docker-compose.caddy.yml", []string{"ghcr.io/erhuz/console_api:2.9.0-management.7", "ghcr.io/erhuz/console_ui:2.9.0-management.7", "autobase/console_db:2.9.0"}, []string{"ghcr.io/erhuz/console_db:"}},
		...
		{"console/service/README.md", []string{"ghcr.io/erhuz/automation:2.9.0-management.7"}, []string{"ghcr.io/erhuz/automation:latest"}},
		{"console/service/internal/configuration/config.go", []string{"ghcr.io/erhuz/automation:2.9.0-management.7"}, []string{"ghcr.io/erhuz/automation:latest"}},
	}
