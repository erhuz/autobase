...
type GetOperationsParams struct {
	...
	// In: query
	ProjectID int64
	// Sort by fields. Example: sort_by=cluster_name,type,status,id,started,finished
	//  Supported values:
	//  - id
	//  - cluster_name
	//  - type
...
// validateEndDate carries out validations for parameter EndDate
...
// validateStartDate carries out validations for parameter StartDate
