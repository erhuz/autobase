...
// validateExtensionType carries out validations for parameter ExtensionType
func (o *GetDatabaseExtensionsParams) validateExtensionType(formats strfmt.Registry) error {

	if err := validate.EnumCase("extension_type", "query", *o.ExtensionType, []any{"all", "contrib", "third_party"}, true); err != nil {
		return err
	}
