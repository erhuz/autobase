...
func NewPgConsoleAPI(spec *loads.Document) *PgConsoleAPI {
	return &PgConsoleAPI{
		...
		PlainTextConsumer: runtime.ConsumerFunc(func(r io.Reader, target any) error {
			_ = r
			_ = target
		...
		ClusterGetClustersIDHealthHandler: cluster.GetClustersIDHealthHandlerFunc(func(params cluster.GetClustersIDHealthParams) middleware.Responder {
			_ = params

			return middleware.NotImplemented("operation cluster.GetClustersIDHealth has not yet been implemented")
		}),

		ClusterGetClustersIDQueryPerformanceHandler: cluster.GetClustersIDQueryPerformanceHandlerFunc(func(params cluster.GetClustersIDQueryPerformanceParams) middleware.Responder {
			_ = params

			return middleware.NotImplemented("operation cluster.GetClustersIDQueryPerformance has not yet been implemented")
		}),

		ClusterGetClustersIDQueryPerformanceFingerprintIDHandler: cluster.GetClustersIDQueryPerformanceFingerprintIDHandlerFunc(func(params cluster.GetClustersIDQueryPerformanceFingerprintIDParams) middleware.Responder {
			_ = params

			return middleware.NotImplemented("operation cluster.GetClustersIDQueryPerformanceFingerprintID has not yet been implemented")
		}),
		...
		OperationGetOperationsIDHandler: operation.GetOperationsIDHandlerFunc(func(params operation.GetOperationsIDParams) middleware.Responder {
			_ = params

			return middleware.NotImplemented("operation operation.GetOperationsID has not yet been implemented")
		}),
		...
		ClusterPostClustersIDOperationsHandler: cluster.PostClustersIDOperationsHandlerFunc(func(params cluster.PostClustersIDOperationsParams) middleware.Responder {
			_ = params

			return middleware.NotImplemented("operation cluster.PostClustersIDOperations has not yet been implemented")
		}),

		ClusterPostClustersIDPreflightsHandler: cluster.PostClustersIDPreflightsHandlerFunc(func(params cluster.PostClustersIDPreflightsParams) middleware.Responder {
			_ = params

			return middleware.NotImplemented("operation cluster.PostClustersIDPreflights has not yet been implemented")
		}),
		...
		ClusterPutClustersIDCredentialHandler: cluster.PutClustersIDCredentialHandlerFunc(func(params cluster.PutClustersIDCredentialParams) middleware.Responder {
			...
			return middleware.NotImplemented("operation cluster.PutClustersIDCredential has not yet been implemented")
		}),
	}
}
...
type PgConsoleAPI struct {
	...
	// ClusterGetClustersIDHealthHandler sets the operation handler for the get clusters ID health operation
	ClusterGetClustersIDHealthHandler cluster.GetClustersIDHealthHandler
	// ClusterGetClustersIDQueryPerformanceHandler sets the operation handler for the get clusters ID query performance operation
	ClusterGetClustersIDQueryPerformanceHandler cluster.GetClustersIDQueryPerformanceHandler
	// ClusterGetClustersIDQueryPerformanceFingerprintIDHandler sets the operation handler for the get clusters ID query performance fingerprint ID operation
	ClusterGetClustersIDQueryPerformanceFingerprintIDHandler cluster.GetClustersIDQueryPerformanceFingerprintIDHandler
	...
	// OperationGetOperationsIDHandler sets the operation handler for the get operations ID operation
	OperationGetOperationsIDHandler operation.GetOperationsIDHandler
	...
	// ClusterPostClustersIDOperationsHandler sets the operation handler for the post clusters ID operations operation
	ClusterPostClustersIDOperationsHandler cluster.PostClustersIDOperationsHandler
	// ClusterPostClustersIDPreflightsHandler sets the operation handler for the post clusters ID preflights operation
	ClusterPostClustersIDPreflightsHandler cluster.PostClustersIDPreflightsHandler
...
func (o *PgConsoleAPI) Validate() error {
	...
	if o.ClusterGetClustersIDHealthHandler == nil {
		unregistered = append(unregistered, "cluster.GetClustersIDHealthHandler")
	}
	if o.ClusterGetClustersIDQueryPerformanceHandler == nil {
		unregistered = append(unregistered, "cluster.GetClustersIDQueryPerformanceHandler")
	}
	if o.ClusterGetClustersIDQueryPerformanceFingerprintIDHandler == nil {
		unregistered = append(unregistered, "cluster.GetClustersIDQueryPerformanceFingerprintIDHandler")
	}
	...
	if o.OperationGetOperationsIDHandler == nil {
		unregistered = append(unregistered, "operation.GetOperationsIDHandler")
	}
	...
	if o.ClusterPostClustersIDOperationsHandler == nil {
		unregistered = append(unregistered, "cluster.PostClustersIDOperationsHandler")
	}
	if o.ClusterPostClustersIDPreflightsHandler == nil {
		unregistered = append(unregistered, "cluster.PostClustersIDPreflightsHandler")
	}
...
func (o *PgConsoleAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/clusters/{id}/health"] = cluster.NewGetClustersIDHealth(o.context, o.ClusterGetClustersIDHealthHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/clusters/{id}/query-performance"] = cluster.NewGetClustersIDQueryPerformance(o.context, o.ClusterGetClustersIDQueryPerformanceHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/clusters/{id}/query-performance/{fingerprint_id}"] = cluster.NewGetClustersIDQueryPerformanceFingerprintID(o.context, o.ClusterGetClustersIDQueryPerformanceFingerprintIDHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/operations/{id}"] = operation.NewGetOperationsID(o.context, o.OperationGetOperationsIDHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["POST"]["/clusters/{id}/operations"] = cluster.NewPostClustersIDOperations(o.context, o.ClusterPostClustersIDOperationsHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/clusters/{id}/preflights"] = cluster.NewPostClustersIDPreflights(o.context, o.ClusterPostClustersIDPreflightsHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	...
	o.handlers["PUT"]["/clusters/{id}/credential"] = cluster.NewPutClustersIDCredential(o.context, o.ClusterPutClustersIDCredentialHandler)
}
